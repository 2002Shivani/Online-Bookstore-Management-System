...
//	public User roleAssign(@RequestBody RoleRequest role) {
//		return service.roleAssign(role);
//	}
	// get all user
	@GetMapping("/getall")
	...
	@GetMapping("/byrole")
	public List<User> getSpecific(@RequestParam String userRoles) {
		return service.getSpecific(userRoles);
	}
